...
export interface ICandidateDocument extends Omit<ICandidateModel, '_id', 'createdAt', 'updatedAt'>, Document {}
export interface ICandidateModel extends Model<IUserDocument> {}
